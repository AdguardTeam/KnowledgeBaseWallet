---
title: How to restore your wallet on a new device
sidebar_position: 4
---
...
AdGuard Wallet does not store your password and cannot recover it. If you forgot your password, you can reset the app — this will remove all wallets and reset the password. You can then restore your wallet using your seed phrase or cloud backup.
