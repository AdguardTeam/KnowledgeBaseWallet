...
`master` branch is published automatically to https://kb-wallet.pages.dev/.

## How to contribute

You can help by contributing to the Knowledge Base, all details are described [in this article](https://adguard-wallet.com/kb/miscellaneous/update-kb/).
...
- `git clone git@github.com:AdguardTeam/KnowledgeBaseWallet.git`
