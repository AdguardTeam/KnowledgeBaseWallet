...
Because the wallet is non-custodial, only you can access your funds. If you lose your seed phrase, no one can help you recover it.
...
The wallet supports more than 7,000 crypto assets across these blockchains:

| Blockchain                             | Type           |
| -------------------------------------- | -------------- |
| Bitcoin                                | UTXO-based     |
| Ethereum, BSC, Polygon, Base, Arbitrum | EVM-compatible |
| Solana                                 | SOL            |
| Tron                                   | TRC-20         |

New blockchains are added with app updates.

## Key features

- **Self-custody** — full control over your private keys and funds
- **Multi-chain support** — management of assets across multiple blockchains in one app
- **Token swap** — competitive rates through SwapKit integration
...
1. Get AdGuard Wallet from the official website or your platform’s app store.
2. Create a new wallet or import an existing one using your seed phrase.
3. Set a strong password and enable biometric authentication.
4. Start sending, receiving, swapping, and buying crypto.

For detailed instructions, see [How to install and set up AdGuard Wallet](/guides/install-and-setup).
