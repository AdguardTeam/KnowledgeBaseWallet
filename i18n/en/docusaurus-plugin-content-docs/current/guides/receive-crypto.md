...
To receive crypto in AdGuard Wallet, share your wallet address or QR code with the sender. Make sure the sender uses the correct network.

To receive crypto:

1. Open AdGuard Wallet and go to the _Receive_ screen.
2. Select the asset you want to receive.
3. If the asset exists on multiple networks, ask the sender which network they will use — and select the same one.
4. Your address and QR code will be displayed. Share them with the sender.
