...
2. Tap the account name or the switcher icon next to it.
...
2. Select the wallet where you want to add an account.
3. Tap _Add account_. A new account will be created and added to your wallet.
...
3. Tap the account name and enter a new name.
...
1. Go to the wallet that contains the account.
2. Open the account settings and tap _Delete account_.
