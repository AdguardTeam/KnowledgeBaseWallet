...
2. Enter the amount. Tap _Max_ to send your full balance (the network fee will be deducted).

<!-- screenshot: Entering recipient and amount -->

1. Review the network fee. The fee is charged separately from the amount you send.
2. Check the details and confirm the transaction with your password or biometrics.
