...
2. Move your funds from the compromised wallet to the new one. Keep in mind that whoever has your seed phrase may try to move them at the same time, so every minute counts.
3. Stop using the compromised wallet and its seed phrase entirely.
...
2. Consider moving your funds to a new wallet with a fresh seed phrase.
...
2. From there, move your funds to a new wallet with a fresh seed phrase.
